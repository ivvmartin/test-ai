    ...
    <SidebarGroup>
      <SidebarGroupContent className="px-2 py-2">
        <button
          onClick={onUpgrade}
          disabled={isPending}
          className="group relative w-full overflow-hidden rounded-lg bg-[#35517f] p-3 text-left text-white shadow-md transition-all hover:bg-[#2d4670] disabled:opacity-50"
        >
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[11.5px] text-white/80 mr-2">
